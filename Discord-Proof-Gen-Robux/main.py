...
class BoostPage:
    ...
    def get_proof(self):
        ...
        elif self.nitro_type == "robux":
               filename = "assets/robux_page.txt"
...
@client.event
async def on_ready():
    await client.change_presence(activity=discord.Activity(type=discord.ActivityType.listening, name="NIKLASHGAMERZ"))
...
class NitroProofCustom(discord.ui.Modal, title='Nitro Proof System'):
    nitrotype = discord.ui.TextInput(
        label='Type of Nitro code:',
        style=discord.TextStyle.short,
        placeholder='Example: classic or boost or promo or robux',
        required=True,
        max_length=7,
    )
    ...
    receivername = discord.ui.TextInput(
        ...
        style=discord.TextStyle.short,
        placeholder='Example: NIKLASHGAMERZ',
        required=True,
        max_length=32,
    )
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        await interaction.followup.send(f"Proof generated! Check your dms for image.", ephemeral=True)
...
class NitroProofId(discord.ui.Modal, title='Nitro Proof System Created'):
    nitrotype = discord.ui.TextInput(
        label='Type of Nitro code:',
        style=discord.TextStyle.short,
        placeholder='Example: classic or boost or promo or robux',
    ...
    receiverid = discord.ui.TextInput(
        ...
        style=discord.TextStyle.short,
        placeholder='Example: 1008105369719025754',
        required=True,
        max_length=18,
    )
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await interaction.followup.send(f"Proof generated! Check your dms lol.", ephemeral=True)
            await interaction.user.send(file=discord.File('proof.png'))
